...
public class Language {
    ...
    @NotNull
    @Size(min = 1, max = 150, message = "name this must be between 1 and 150 characterts (inclusive:")
    private String name;
    @NotNull
    @Size(min = 1, max = 150, message = "nativeName this must be between 1 and 150 characterts (inclusive):")
